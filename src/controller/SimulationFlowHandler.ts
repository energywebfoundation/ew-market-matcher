...
export const handleFlowAction = async (
  ...
  switch (simulationFlowAction.type) {
    case SimulationFlowDef.Agreement.RegisterAgreementActionType
      .RegisterAgreement:
    ...
    case SimulationFlowDef.ProducingAsset.RegisterProducingAssetActionType
      ...
      break;
    case SimulationFlowDef.Certificate.RegisterCertificateActionType
      .RegisterCertificate:
    ...
    default:
      throw new Error(
        "Unsupported simulation flow action type " +
          (simulationFlowAction as any).type
      );
  }
};
